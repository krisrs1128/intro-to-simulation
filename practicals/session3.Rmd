...
We need to define a new link that no longer depends on `Category`. One solution is to modify the existing simulator in place using `mutate`.
```{r, eval = fALSE}
...
Given this new simulator we can 
